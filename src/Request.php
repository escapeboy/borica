...
use Borica\Exceptions\InvalidParameterException;
use Borica\Exceptions\LengthException;
...
class Request
{
    ...
    public function __construct()
    {
        ...
        $this->privateKey = config('borica.private_key_file');
        $this->privateKeyPassword = config('borica.private_key_password');
        $this->useFileKeyReader = config('borica.use_key_file_reader');
        $this->language = strtoupper(config('app.locale'));
        $this->debug = config('borica.debug');
        $this->currency = config('borica.currency');
    }
